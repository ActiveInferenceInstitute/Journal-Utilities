---
title: ""Physics as Information Processing" ~ Chris Fields ~ Lecture 4"
category: "Courses/PhysicsAsInformationProcessing_ChrisFields"
speakers:
  - "Chris Fields ~ Lecture 4"
duration: "1:06:13"
url: "https://www.youtube.com/watch?v=k55mAFCIQ60"
views: 2200
exported_at: "2026-02-18T22:37:37.902054+00:00"
format: markdown
---

# "Physics as Information Processing" ~ Chris Fields ~ Lecture 4

Hello and welcome everyone. This is Physics as Information Processing, Session 4 on Communicating Observers.
...
And we discussed a little bit this theorem that if two reference frames or quantum processes, Q1 and Q2, don't commute,
...
And we can do this because we were able to prove, Jim Glazeberg and Tonino Marciano and I were able to prove last year, that we can always represent a quantum reference frame as a topological quantum field theory.
...
and we perfectly align their quantum reference frames, which is what the FEP says they will tend to do,
then they become entangled.
...
Another thing to recall from a couple of sessions ago, or last session, is that if two reference frames, Q1 and Q2, commute,
...
So what we're going to be interested in is situations where this doesn't happen,
...
and various kinds of mysterification of entanglement.
